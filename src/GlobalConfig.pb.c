...
const pb_field_t GlobalConfigMessage_fields[8] = {
    ...
    PB_FIELD(  4, MESSAGE , SINGULAR, STATIC  , OTHER, GlobalConfigMessage, debug, http, &DebugConfigMessage_fields),
 ...
 * field descriptors.
 */
PB_STATIC_ASSERT((pb_membersize(GlobalConfigMessage, wifi) < 65536 && pb_membersize(GlobalConfigMessage, http) < 65536 && pb_membersize(GlobalConfigMessage, debug) < 65536 && pb_membersize(GlobalConfigMessage, module_cfg) < 65536), YOU_MUST_DEFINE_PB_FIELD_32BIT_FOR_MESSAGES_GlobalConfigMessage_WifiConfigMessage_HttpConfigMessage_DebugConfigMessage)
#endif
